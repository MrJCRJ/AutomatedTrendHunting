...
export function buildBaseScript() {
  return `(function(){
    ...
    if(btnTrends)btnTrends.addEventListener('click',()=>exec('/api/executar-tendencias',btnTrends));
    if(btnMonet)btnMonet.addEventListener('click',()=>exec('/api/monetizar',btnMonet));
